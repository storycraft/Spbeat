...
import cf.kuiprux.spbeat.object.BasicInfo;
import cf.kuiprux.spbeat.object.Bpm;
import cf.kuiprux.spbeat.object.Map;
import cf.kuiprux.spbeat.object.Note;
import cf.kuiprux.spbeat.object.PlayInfo;
...
public class MapLoader {
	...
	private void parse(File infoFile, File notesFile, File iconFile, File musicFile) throws IOException, SlickException{
		...
		maps.add(new Map(basicInfo, playInfo, image, musicFile.getAbsolutePath()));
	}
